...
namespace GameWindowSize.GraphicsSupport
{
    class Camera
    {
        /*Variáveis que irão representar a origem, largura (width),e o rácio(ratio) entre camera e a pixel window:*/
        ...
        /*Função que calcula e retorna o rácio	entre as duas janelas(Camera e Pixel Window) */
